...
<head>
	...
	<style>
		...
		#main1{
			background-image: url('img/book_bkg.jpg');
...
<body height="100%" width="100%">
			...
			<nav id = "nav">
					<div>
						<ul>
							<li id="logolist">
								<a href="home.php">
									<img id = "cart" src="img/main_logo.png" vspace = "0" hspace = "0" height="46" width="130">
								</a>
							</li>
						</ul>
					</div>
					<div class="menu">
						<ul id="ul1">
							...
							<li id="mlist" class= "dropdown"><a href="shop.php">SHOP</a>
								<ul id = "drop-menu">
								<li><a href="hteepg1.php">Fiction Novels</a></li>
								<li><a href="fteepg1.php">Non-Fiction Novels</a></li>
								<li><a href="pteepg1.php">Thrillers</a></li>
								</ul>
							</li>
						</ul>
						<ul id= "ul2">
							<li id="mlist">
								<form id="searchContainer">
										<input id= "searchinput" placeholder=" Search from mystery, fantasies , and many more... " type="text">
	...
	<section id="content">
		<div id="main1">
			<div id="main1above">
				<img id = "royallogo" src="img/book_fly.jpg">
			</div>
		</div>
		<div id="main2">
				<div id="main2str">
					<h2 align="center">BookGeeks SUBSCRIPTION</h2>
				...
				<div id="main2end">
					<h2 align="center">GET ACCESS TO ALL OUR E-BOOKS WITH <br> OUR MEMEBERSHIP FOR ONLY $99 FOR FIRST YEAR</h2>
				</div>
		</div>
		<div id="main3">
			<div id="main3head">
			...
			<div id ="main3mid">
				<div id="main3pic">
					<img id = "hiw" src="img/stepp1.jpg" >
					<p>1. Choose your preferences </p>
				</div>
				<div id="main3pic">
					<img id = "hiw" src="img/book_heap.png" style="height:200px;" >
					<p>2. Select your favourites </p>
				</div>
				<div id="main3pic">
					<img id = "hiw" src="img/person_reading.png" >
					<p>3. Relax and Dive into <br>awesomeness.</p>
				</div>
			</div>
		</div>
		<div id="mainget">
		...
		<footer id="foot">
				<div id="flogo">
					<a href="home.php"><img src="img/main_logo.png" height="15%" width="15%"></a>
				</div>
				<div id="fdetail">
					<div id="fitem">
					...
					<div id="fitem">
							...
							<a href="https://www.facebook.com"><i class="fa fa-facebook-official" aria-hidden="true"></i> 100K People Like This</a><br>
							<a href="https://www.instagram.com"><i class="fa fa-instagram" aria-hidden="true"></i> 20K Followers</a><br>
							<div id ="faline">
