...
<body height="100%" width="100%">
	...
	<div id= "main">
		<div id="bread">
			<p><a href="men.php">Men</a> &nbsp / &nbsp <a href="menhalfsleeve.php">Half Sleeve T-Shirt's</a> &nbsp / &nbsp <a href="htee4.php">FHM LA</a></p>  <!--Edit Here -->
		</div>
		<div id="item">
			<div id= "content">
				<img src="img/htee4.jpg" height="620px" width="495px"><!-- Edit Here-->
			</div>
			<div id="itemdetail">
				<h2><b>FHM LA</b></h2><!-- Edit Here-->
				<p id="categ">Men's Half Sleeve T-Shirts</p>
				<p id="prices">&#8377 </p><p id="price"> 495</p><br><!-- Edit Here-->
				<p id="dechead"><br><br>Description</p><p id="deccont">Walk the LA streets, no matter where you are! This men’s T-shirt in white is the perfect edit to compliment your attitude. With this printed half sleeve tee, you are bound to wow everyone with your cool style. Think you need it? Get yours now!&nbsp;</p>
				<hr>
		...
		<div>
			...
			<div id="suggest">
				...
				<div id= "ymal">
					<a href="htee1.php"><img src="img/htee1.jpg" height="620px" width="495px">
					<p>Moksha</p>
					<p>&#8377 495</p></a>
				</div>
				<div id= "ymal">
